...
export default function IconNotificationsOutline(props) {
  return (
    <svg
      viewBox="0 0 20 20"
      fill="currentColor"
...
export function IconCalendarTwo(props) {
  return (
    <svg fill="none" viewBox="0 0 24 24" height="1em" width="1em" {...props}>
      <path fill="currentColor" d="M8 7a1 1 0 000 2h8a1 1 0 100-2H8z" />
      <path
        fill="currentColor"
        fillRule="evenodd"
...
export function IconBxMenuAltRight(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export function IconLineChartLine(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export function IconBarChartLine(props) {
  return (
    <svg
      fill="currentColor"
      viewBox="0 0 16 16"
...
export function IconFolderOutline(props) {
  return (
    <svg
      viewBox="0 0 512 512"
      fill="currentColor"
...
export function IconHomeOutline(props) {
  return (
    <svg
      viewBox="0 0 512 512"
      fill="currentColor"
...
export function IconTeamLine(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export function IconProgressCheck(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export function IconBellRingOutline(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
      ...
      {...props}
    >
      <path d="M10 21h4a2 2 0 01-2 2 2 2 0 01-2-2m11-2v1H3v-1l2-2v-6c0-3.1 2.03-5.83 5-6.71V4a2 2 0 012-2 2 2 0 012 2v.29c2.97.88 5 3.61 5 6.71v6l2 2m-4-8a5 5 0 00-5-5 5 5 0 00-5 5v7h10v-7m2.75-7.81l-1.42 1.42A8.982 8.982 0 0121 11h2c0-2.93-1.16-5.75-3.25-7.81M1 11h2c0-2.4.96-4.7 2.67-6.39L4.25 3.19A10.96 10.96 0 001 11z" />
    </svg>
  );
}

export function IconAccountCircleLine(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export function IconTimeOutline(props) {
  return (
    <svg
      viewBox="0 0 512 512"
      fill="currentColor"
...
export function IconMoneyEuroCircleLine(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export function IconBxsPlusCircle(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
